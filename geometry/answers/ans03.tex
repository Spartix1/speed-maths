...
%── C3 ──────────────────────────────────────────────────────────────────────────
\item The circles $x^2+y^2=169$ and $x^2+y^2-6x+8y-119=0$ meet at $P$ and $Q$. What is the length $PQ$? \textit{\small(after TMUA 2016 Paper 2 Q9)}
\begin{itemize}
\item[A)] $12$
\item[B)] $16$
\item[C)] $24$
...
%── C5 ──────────────────────────────────────────────────────────────────────────
\item The circle $x^2+y^2+4x-2y+C=0$ is orthogonal to the circle $x^2+y^2-4x+4y-1=0$. What is $C$? \textit{\small(after Oxbridge Paper 1 Q8)}
\begin{itemize}
\item[A)] $-11$
\item[B)] $-8$
\item[C)] $11$
...
%── D1 ──────────────────────────────────────────────────────────────────────────
\item The circles $C_1:(x+2)^2+(y-3)^2=18$ and $C_2:(x-7)^2+(y+6)^2=2$ have centres $O_1$ and $O_2$. What is the shortest distance between a point on $C_1$ and a point on $C_2$? \textit{\small(adapted from TMUA 2018 Paper 1 Q3)}
\begin{itemize}
\item[A)] $5\sqrt2-4$
\item[B)] $5\sqrt2-5$
\item[C)] $5\sqrt2$
...
%── D4 ──────────────────────────────────────────────────────────────────────────
\item Two circles of radii $3$ and $4$ are orthogonal. What is the length of their common chord? \textit{\small(after TMUA 2016 Paper 2 Q9 $/$ Oxbridge)}
\begin{itemize}
\item[A)] $\dfrac{24}{5}$
\item[B)] $\dfrac{12}{5}$
\item[C)] $6$
...
%── D5 ──────────────────────────────────────────────────────────────────────────
\item A point $P$ has equal power with respect to the circles $x^2+y^2=1$ and $(x-6)^2+y^2=4$. What does the locus of $P$ describe? \textit{\small(adapted from JZMaths $/$ Vantage)}
\begin{itemize}
