...
\vspace{0pt}
A circle has centre $(9,11)$ and radius $5$. A regular hexagon $ABCDEF$ is inscribed with all vertices on the circle. What is the area of the hexagon? \textit{\small(adapted from TMUA 2017 Paper 1 Q9)}
\begin{itemize}
\item[A)] $18\sqrt3$
\item[B)] $36\sqrt3$
