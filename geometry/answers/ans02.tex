...
%── C2 ──────────────────────────────────────────────────────────────────────────
\item \textit{\small(adapted from TMUA 2018 Paper 1 Q7)} The point $P(8,6)$ is outside the circle $x^2+y^2=36$. Tangents from $P$ meet the circle at $A$ and $B$. What is the length $AB$?
\begin{itemize}
...
\end{tikzpicture} \textit{\small(adapted from TMUA 2017 Paper 1 Q9)} A circle has centre $(9,11)$ and radius $5$. A regular hexagon $ABCDEF$ is inscribed with all vertices on the circle. What is the area of the hexagon?
\begin{itemize}
\item[A)] $18\sqrt3$
\item[B)] $36\sqrt3$
...
\end{tikzpicture} \textit{\small(adapted from TMUA 2018 Paper 1 Q7 / 2022 Paper 1 Q3)} The circles $C_1:(x+2)^2+(y-3)^2=18$ and $C_2:(x-7)^2+(y+6)^2=2$ have centres $O_1,O_2$. What is the \emph{shortest} distance between a point on $C_1$ and a point on $C_2$?
\begin{itemize}
\item[A)] $5\sqrt2-4$
\item[B)] $5\sqrt2-5$
\item[C)] $5\sqrt2$
...
\end{tikzpicture} \textit{\small(adapted from TMUA 2022 Paper 1 Q14)} Circle $O$ radius $6$, $\angle POQ\ge \pi/2$, area $[POQ]=9\sqrt3$. For variable $R$ on the major arc $PQ$, what is the \emph{greatest possible} area of $\triangle PRQ$?
\begin{itemize}
\item[A)] $18+9\sqrt3$
\item[B)] $27\sqrt3$
\item[C)] $27+9\sqrt3$
...
%── D4 ──────────────────────────────────────────────────────────────────────────
\item \textit{\small(after MAT 2020 Q1H)} Let $P(p,q)$ and circle $C: x^2+2fx+y^2+2gy+h=0$ with centre $C_0=(-f,-g)$ and $L=|PC_0|$. Which set is \emph{minimal sufficient} to compute $L$?
\begin{itemize}
\item[A)] $f,g,h$
\item[B)] $f,g,p,q$
\item[C)] $f,h,p,q$
...
\end{tikzpicture} \textit{\small(adapted from BMO1 2010 Q4)} $ABCD$ is a cyclic quadrilateral with perpendicular diagonals intersecting at $E$. The line through $E$ perpendicular to $AB$ meets $CD$ at $F$. Which statement is \emph{necessarily true}?
\begin{itemize}
