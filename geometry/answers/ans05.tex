...
\vspace{0pt}
The circle $x^2+y^2-6x-8y+24=0$ has centre $(3,4)$, $r=1$. $P(6,8)$ is outside. What is the tangent length? \textit{\small(after MAT 2021 Q5)}
\end{minipage}\hfill
...
\item \begin{minipage}[t]{0.70\linewidth}
\vspace{0pt}
The chord of contact from $P(3,3)$ to $x^2+y^2=9$ is $x+y=3$. What is its length? \textit{\small(adapted from TMUA 2019 Paper 1 Q6)}
\end{minipage}\hfill
\begin{minipage}[t]{0.26\linewidth}
\vspace{0pt}
\centering
