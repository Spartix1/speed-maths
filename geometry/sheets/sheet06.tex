...
\item \textit{\small(after BMO1 2010 Q4)} A cyclic quadrilateral has sides $4,5,5,6$ (in order). By Brahmagupta $K=\sqrt{(s-a)(s-b)(s-c)(s-d)}$, its area is?
\begin{itemize}
\item[A)] $10\sqrt{6}$
\item[B)] $12\sqrt{5}$
\item[C)] $30$
...
\item \textit{\small(after BMO1 2015 Q3)} A tangential quadrilateral $ABCD$ circumscribes a circle with $AB=3x$, $BC=8$, $CD=5$, $DA=2x+3$. Given Pitot $AB+CD=BC+DA$, find $x$ and hence $DA$.
\begin{itemize}
\item[A)] $12$
\item[B)] $15$
\item[C)] $18$
...
\item \textit{\small(after TMUA 2019 Paper 1 Q7)} From external $P$, secants $PAB$ ($PA=4$, $PB=18$) and $PCD$ ($PC=6$) cut the same circle. Find $CD$.
\begin{itemize}
\item[A)] $6$
\item[B)] $12$
\item[C)] $9$
...
\item \textit{\small(after TMUA Specimen Paper 2 Q9)} Cyclic quadrilateral $ABCD$ has $AB=8$, $BC=6$, $CD=6$, $DA=6$ and $AC=12$. Find $BD$ (Ptolemy).
\begin{itemize}
\item[A)] $7$
\item[B)] $12$
\item[C)] $14$
...
\item \textit{\small(after BMO1 2010 Q4)} Cyclic quadrilateral with sides $5,5,8,14$ has area (Brahmagupta, $s=16$) equal to?
\begin{itemize}
\item[A)] $44$
\item[B)] $36$
\item[C)] $48$
...
\item \textit{\small(after BMO1 2010 Q4)} Cyclic quadrilateral $ABCD$ has sides $2,5,10,11$ (in order, $s=14$). Its Brahmagupta area is?
\begin{itemize}
\item[A)] $36$
\item[B)] $44$
\item[C)] $30$
...
\item \textit{\small(after BMO1 2011 Q2)} Cyclic quadrilateral $ABCD$ has $AB=7$, $BC=8$, $CD=7$, $DA=9$ with $AC=11$. Find $BD$ via Ptolemy.
\begin{itemize}
\item[A)] $11$
\item[B)] $7$
\item[C)] $14$
...
\item \textit{\small(after TMUA 2020 Paper 1 Q7)} From external $P$, tangent $PT=12$ and secant $PAB$ satisfies $PB=PA+10$ with $PT^{2}=PA\cdot PB$. Find $PA$.
\begin{itemize}
\item[A)] $6$
\item[B)] $8$
\item[C)] $12$
...
\item \textit{\small(after BMO1 2015 Q3)} A quadrilateral with sides $5,5,8,8$ (in order $AB=5,BC=5,CD=8,DA=8$) is both tangential (Pitot $5+8=5+8$) and cyclic. Its Brahmagupta area is?
\begin{itemize}
\item[A)] $40$
\item[B)] $30$
\item[C)] $36$
...
\item \textit{\small(after TMUA 2017 Paper 2 Q15)} Cyclic quadrilateral $ABCD$ has $AB=6$, $BC=8$, $CD=12$, $DA=10$ and $AC=8$. Find $BD$.
\begin{itemize}
\item[A)] $19$
\item[B)] $12$
\item[C)] $15$
