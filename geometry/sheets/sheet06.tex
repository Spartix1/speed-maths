...
\end{tikzpicture} \textit{\small(after TMUA 2023 Paper 2 Q9)} Chords $AB$ and $CD$ meet at $P$ inside a circle with $PA=6$, $PB=8$ and $CP:PD=3:4$. Find $CP$.
\begin{itemize}
\item[A)] $4$
\item[B)] $6$
\item[C)] $8$
...
\end{tikzpicture} \textit{\small(after TMUA 2017 Paper 1 Q6)} From external $P$, tangent $PT=12$ touches a circle and secant $PAB$ meets it with $PA=8$. Find the chord $AB$.
\begin{itemize}
\item[A)] $6$
\item[B)] $10$
\item[C)] $12$
...
\end{tikzpicture} \textit{\small(after TMUA 2017 Paper 2 Q15)} Cyclic quadrilateral $ABCD$ has $AB=6$, $BC=4$, $CD=5$, $DA=3$ and diagonal $AC=7$. Find the other diagonal $BD$ (Ptolemy: $AC\cdot BD=AB\cdot CD+BC\cdot AD$).
\begin{itemize}
\item[A)] $5$
\item[B)] $7$
\item[C)] $6$
...
\item \begin{tikzpicture}[scale=0.46, baseline=-0.5ex]
\draw (0,0) circle (1.4);
\coordinate (A) at (1.25,0.6);
\coordinate (B) at (-0.4,1.34);
\coordinate (C) at (-1.3,-0.5);
\coordinate (D) at (0.5,-1.3);
\draw (A) -- (B) -- (C) -- (D) -- cycle;
\end{tikzpicture} \textit{\small(after BMO1 2010 Q4)} A cyclic quadrilateral has sides $4,5,5,6$ (in order). By Brahmagupta $K=\sqrt{(s-a)(s-b)(s-c)(s-d)}$, its area is?
\begin{itemize}
\item[A)] $10\sqrt{6}$
\item[B)] $12\sqrt{5}$
\item[C)] $30$
...
\item \begin{tikzpicture}[scale=0.44, baseline=-0.5ex]
\draw (0,0) circle (1.2);
\draw (-1.0,0.6) -- (0.9,0.6) -- (0.7,-0.9) -- (-0.9,-0.9) -- cycle;
\node at (0,1.3) {\tiny incircle};
\end{tikzpicture} \textit{\small(after BMO1 2015 Q3)} A tangential quadrilateral $ABCD$ circumscribes a circle with $AB=3x$, $BC=8$, $CD=5$, $DA=2x+3$. Given Pitot $AB+CD=BC+DA$, find $x$ and hence $DA$.
\begin{itemize}
\item[A)] $12$
\item[B)] $15$
\item[C)] $18$
...
\item \begin{tikzpicture}[scale=0.45, baseline=-0.5ex]
\draw (0,0) circle (1.4);
\fill (2.6,0.3) circle (1.2pt) node[right]{\tiny $P$};
\draw (2.6,0.3) -- (-1.3,0.5);
\draw (2.6,0.3) -- (-0.9,-1.07);
\node at (-1.3,0.5) [left]{\tiny $A$};
\node at (-0.3,0.15) [above]{\tiny $B$};
\node at (-0.9,-1.07) [left]{\tiny $C$};
\node at (0.25,-0.6) [below]{\tiny $D$};
\end{tikzpicture} \textit{\small(after TMUA 2019 Paper 1 Q7)} From external $P$, secants $PAB$ ($PA=4$, $PB=18$) and $PCD$ ($PC=6$) cut the same circle. Find $CD$.
\begin{itemize}
\item[A)] $6$
\item[B)] $12$
\item[C)] $9$
...
\item \begin{tikzpicture}[scale=0.46, baseline=-0.5ex]
\draw (0,0) circle (1.4);
\coordinate (A) at (1.32,0.47);
\coordinate (B) at (0.2,1.38);
\coordinate (C) at (-1.32,-0.47);
\coordinate (D) at (-0.2,-1.38);
\draw (A) -- (B) -- (C) -- (D) -- cycle;
\draw (A) -- (C);
\end{tikzpicture} \textit{\small(after TMUA Specimen Paper 2 Q9)} Cyclic quadrilateral $ABCD$ has $AB=8$, $BC=6$, $CD=6$, $DA=6$ and $AC=12$. Find $BD$ (Ptolemy).
\begin{itemize}
\item[A)] $7$
\item[B)] $12$
\item[C)] $14$
...
\item \begin{tikzpicture}[scale=0.46, baseline=-0.5ex]
\draw (0,0) circle (1.4);
\coordinate (A) at (1.35,0.35);
\coordinate (B) at (0.35,1.35);
\coordinate (C) at (-1.2,0.7);
\coordinate (D) at (-0.6,-1.26);
\draw (A) -- (B) -- (C) -- (D) -- cycle;
\end{tikzpicture} \textit{\small(after BMO1 2010 Q4)} Cyclic quadrilateral with sides $5,5,8,14$ has area (Brahmagupta, $s=16$) equal to?
\begin{itemize}
\item[A)] $44$
\item[B)] $36$
\item[C)] $48$
...
\item \begin{tikzpicture}[scale=0.46, baseline=-0.5ex]
\draw (0,0) circle (1.4);
\coordinate (A) at (1.2,0.7);
\coordinate (B) at (-0.8,1.15);
\coordinate (C) at (-1.25,-0.6);
\coordinate (D) at (0.6,-1.26);
\draw (A) -- (B) -- (C) -- (D) -- cycle;
\end{tikzpicture} \textit{\small(after BMO1 2010 Q4)} Cyclic quadrilateral $ABCD$ has sides $2,5,10,11$ (in order, $s=14$). Its Brahmagupta area is?
\begin{itemize}
\item[A)] $36$
\item[B)] $44$
\item[C)] $30$
...
\coordinate (A) at (1.35,0.53);
\coordinate (B) at (0.4,1.39);
\coordinate (C) at (-1.25,0.73);
\coordinate (D) at (-0.5,-1.36);
\draw (A) -- (B) -- (C) -- (D) -- cycle;
\draw (A) -- (C); \draw (B) -- (D);
\end{tikzpicture} \textit{\small(after BMO1 2011 Q2)} Cyclic quadrilateral $ABCD$ has $AB=7$, $BC=8$, $CD=7$, $DA=9$ with $AC=11$. Find $BD$ via Ptolemy.
\begin{itemize}
\item[A)] $11$
\item[B)] $7$
\item[C)] $14$
...
\item \begin{tikzpicture}[scale=0.45, baseline=-0.5ex]
\draw (0,0) circle (1.3);
\fill (2.5,0.2) circle (1.2pt) node[right]{\tiny $P$};
\draw (2.5,0.2) -- (1.15,0.6);
\draw (2.5,0.2) -- (-0.45,1.22);
\draw (2.5,0.2) -- (0.3,-1.26);
\node at (1.15,0.6) [above]{\tiny $A$};
\node at (0.2,1.15) [above]{\tiny $B$};
\end{tikzpicture} \textit{\small(after TMUA 2020 Paper 1 Q7)} From external $P$, tangent $PT=12$ and secant $PAB$ satisfies $PB=PA+10$ with $PT^{2}=PA\cdot PB$. Find $PA$.
\begin{itemize}
\item[A)] $6$
\item[B)] $8$
\item[C)] $12$
...
\draw (-0.95,0.55) -- (0.90,0.55) -- (0.90,-0.70) -- (-0.95,-0.70) -- cycle;
\coordinate (A) at (-0.95,0.55); \coordinate (B) at (0.90,0.55);
\coordinate (C) at (0.90,-0.70); \coordinate (D) at (-0.95,-0.70);
\node at (A) [left]{\tiny $5$}; \node at (B) [right]{\tiny $5$}; \node at (C) [right]{\tiny $8$}; \node at (D) [left]{\tiny $8$};
\end{tikzpicture} \textit{\small(after BMO1 2015 Q3)} A quadrilateral with sides $5,5,8,8$ (in order $AB=5,BC=5,CD=8,DA=8$) is both tangential (Pitot $5+8=5+8$) and cyclic. Its Brahmagupta area is?
\begin{itemize}
\item[A)] $40$
\item[B)] $30$
\item[C)] $36$
...
\item \begin{tikzpicture}[scale=0.47, baseline=-0.5ex]
\draw (0,0) circle (1.45);
\coordinate (A) at (1.38,0.44);
\coordinate (B) at (0.44,1.38);
\coordinate (C) at (-1.2,0.8);
\coordinate (D) at (-0.6,-1.31);
\draw (A) -- (B) -- (C) -- (D) -- cycle;
\draw (A) -- (C);
\end{tikzpicture} \textit{\small(after TMUA 2017 Paper 2 Q15)} Cyclic quadrilateral $ABCD$ has $AB=6$, $BC=8$, $CD=12$, $DA=10$ and $AC=8$. Find $BD$.
\begin{itemize}
\item[A)] $19$
\item[B)] $12$
\item[C)] $15$
