...
\end{tikzpicture} \textit{\small(adapted from TMUA 2017 Paper 1 Q9)} A circle has equation $x^2+y^2-18x-22y+178=0$ (centre $(9,11)$, $r=5$). A regular hexagon $ABCDEF$ is inscribed so that all vertices lie on the circle. What is the area of the hexagon?
\begin{itemize}
\item[A)] $18\sqrt3$
\item[B)] $36\sqrt3$
