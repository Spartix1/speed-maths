...
\item \textit{\small(after TMUA 2018 Paper 2 Q5 $/$ TMUA 2022 Paper 2 Q11)} The locus of points equidistant from the lines $L_1:x+y=0$ and $L_2:x-y=0$ is:
\begin{itemize}
\item[A)] $y=x$
\item[B)] $y=-x$
\item[C)] $y=|x|$
...
\item \textit{\small(after TMUA 2020 Paper 2 Q7)} $PQRS$ is a parallelogram labelled anticlockwise. Consider: I.\ $PQ=QR$ \quad II.\ $PR\perp QS$ \quad III.\ $\angle PQR = 90^\circ$. Which of these conditions is/are individually {\em sufficient} for $PQRS$ to be a square?
\begin{itemize}
\item[A)] I only
\item[B)] II only
\item[C)] III only
...
\item \textit{\small(after TMUA 2018 Paper 2 Q14)} In $\triangle PQR$, $PR=4$, $QR=p$ and $\angle RPQ=30^\circ$. For which values of $p$ does this information {\em uniquely} determine the length $PQ$?
\begin{itemize}
\item[A)] $p=2$
\item[B)] $p=\sqrt3$
\item[C)] $1\le p<2$
...
\item \textit{\small(after TMUA 2019 Paper 1 Q6)} The circles $C_1:(x+3)^2+(y-1)^2=25$ and $C_2:(x-8)^2+(y-1)^2=9$ have radii $5$ and $3$. How many common tangents do they have?
\begin{itemize}
\item[A)] $0$
\item[B)] $1$
\item[C)] $2$
...
\item \textit{\small(after TMUA 2022 Paper 1 Q7)} The Apollonius circle $PA=3\,PB$ with $A=(0,0)$, $B=(6,0)$ is $(x-\tfrac{27}{4})^2+y^2=(\tfrac94)^2$. What is the greatest distance from the origin to a point on this circle?
\begin{itemize}
\item[A)] $9$
\item[B)] $7.5$
\item[C)] $12$
...
\item \textit{\small(after BMO1 2017 Q4 $/$ TMUA 2022 Paper 1 Q7)} The locus of $P$ with $PA^2+PB^2=34$, where $A=(-3,0)$, $B=(3,0)$, is a circle. What is its radius?
\begin{itemize}
\item[A)] $2\sqrt2$
\item[B)] $4$
\item[C)] $\sqrt8$
...
\item \textit{\small(after TMUA 2021 Paper 1 Q9)} The graph $|x|+|y|=3$ is a square (diamond) with vertices $(3,0),(0,3),(-3,0),(0,-3)$. What is the finite area it encloses?
\begin{itemize}
\item[A)] $6$
\item[B)] $12$
\item[C)] $18$
...
\item \textit{\small(after TMUA 2022 Paper 2 Q11)} The diagram shows a kite $PQRS$ whose diagonals meet at $O$ with $OP=x$, $OQ=y$, $OR=x$, $OS=z$. Which condition is {\em necessary and sufficient} for $\angle SPQ=90^\circ$?
\begin{itemize}
\item[A)] $x=y=z$
\item[B)] $2x=y+z$
\item[C)] $x^2=yz$
...
\item \textit{\small(after BMO1 2017 Q4 $/$ TMUA Practice Paper 2 Q9)} The circles $C_1:x^2+y^2=25$ and $C_2:(x-4)^2+y^2=9$ intersect at $P,Q$. What is the length $PQ$?
\begin{itemize}
\item[A)] $3$
\item[B)] $6$
...
\item \textit{\small(after TMUA 2022 Paper 1 Q7 $/$ BMO1 2017 Q4)} Let the Apollonius circle $PA=2PB$ with $A=(0,0)$, $B=(6,0)$ be $(x-8)^2+y^2=16$. The triangle $PAB$ varies as $P$ runs over this circle. What is its maximum possible area?
