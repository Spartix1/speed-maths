...
\item \textit{\small(adapted from TMUA 2019 Paper 1 Q6)} The chord of contact from $P(3,3)$ to $x^2+y^2=9$ is $x+y=3$. What is its length? (Hint: distance from $O$ to chord is $3/\sqrt2$, $r=3$)
\begin{itemize}
\item[A)] $3\sqrt2$
...
\item \textit{\small(adapted from MAT 2021 Q5)} The polar of $(9,12)$ w.r.t. $x^2+y^2=81$ is $3x+4y=27$. What is its distance from the origin, and is $P$ outside/inside/on?
\begin{itemize}
