...
\item \textit{\small(after TMUA 2020 Paper 1 Q16 / BMO1 2013 Q4)} From $P(8,12)$, two tangents are drawn to $x^2+y^2=36$ (centre $O$, $r=6$). Let $T_1T_2$ be the chord of contact. What is the distance from $O$ to the line $T_1T_2$?
\begin{itemize}
\item[A)] $\tfrac{9}{5}$
\item[B)] $\tfrac{18}{5}$
\item[C)] $\tfrac{36}{5}$
...
\item \textit{\small(adapted from TMUA 2018 Paper 1 Q7)} The locus of points $P$ where the tangent length to $x^2+y^2=4$ equals the tangent length to $(x-6)^2+y^2=16$ is the radical axis. Which line is it?
\begin{itemize}
\item[A)] $x=1$
\item[B)] $x=2$
\item[C)] $x=3$
...
\end{tikzpicture} \textit{\small(after MAT 2021 Q5)} The circle $x^2+y^2-6x-8y+24=0$ has centre $(3,4)$, $r=1$. The point $P(6,8)$ is outside. What is the length of the tangent from $P$ to the circle?
\begin{itemize}
\item[A)] $4$
\item[B)] $2\sqrt5$
\item[C)] $5$
...
\item \textit{\small(adapted from BMO1 2015 Q3)} For the $13$-$14$-$15$ triangle ($s=21$, $r=4$), the two tangent lengths from the vertex opposite side $14$ are $s-b$. With $b=14$, what is that length?
\begin{itemize}
\item[A)] $6$
\item[B)] $7$
\item[C)] $8$
...
\item \textit{\small(after TMUA 2022 Paper 1 Q19)} The circle $(x-4)^2+y^2=9$ has director circle $x^2+y^2=2r^2$ for a centred circle, but this circle is translated. What is the locus of points from which the two tangents to $(x-4)^2+y^2=9$ are perpendicular?
\begin{itemize}
\item[A)] $(x-4)^2+y^2=18$
\item[B)] $(x-4)^2+y^2=9$
\item[C)] $x^2+y^2=18$
...
\end{tikzpicture} \textit{\small(adapted from TMUA 2020 Paper 1 Q16)} The point $(8,6)$ is at distance $10$ from the origin. Tangents from $(8,6)$ to $x^2+y^2=1$ have length $\sqrt{99}$. What is the distance from the origin to the chord of contact?
\begin{itemize}
\item[A)] $\tfrac{1}{10}$
...
\item \textit{\small(after BMO1 2020 Q3)} The triangle with sides $13,14,15$ has incircle touching $BC$ at $D$. If $BD=6$, $DC=9$, and $s=21$, the two equal tangents from $A$ are $s-a$. What is $AE$ (tangents from $A$)?
\begin{itemize}
\item[A)] $6$
\item[B)] $7$
\item[C)] $8$
...
\item \textit{\small(adapted from TMUA 2021 Paper 2 Q7)} The chord of contact of $(2,1)$ w.r.t. $x^2+y^2=1$ is $2x+y=1$. What is its distance from the origin, and is it inside, on, or outside the circle?
\begin{itemize}
...
\draw[fill=black] (0,0) circle (1pt);
\end{tikzpicture} \textit{\small(after TMUA 2018 Paper 1 Q7 / BMO1 2023 Q4)} Two tangents from $P$ to $x^2+y^2=9$ with $OP=6$ enclose angle $\theta$. What is $\theta$?
\begin{itemize}
\item[A)] $30^\circ$
\item[B)] $60^\circ$
\item[C)] $90^\circ$
...
\item \textit{\small(adapted from TMUA 2020 Paper 1 Q16)} From $P$ to $x^2+y^2=25$, tangent length is $5\sqrt3$. Find $OP$ (use $OP^2=r^2+\text{tangent}^2$).
\begin{itemize}
\item[A)] $10$
\item[B)] $5\sqrt{10}$
\item[C)] $10\sqrt{3}$
...
\end{tikzpicture} \textit{\small(adapted from TMUA 2019 Paper 1 Q6)} The chord of contact from $P(3,3)$ to $x^2+y^2=9$ is $x+y=3$. What is its length? (Hint: distance from $O$ to chord is $3/\sqrt2$, $r=3$)
\begin{itemize}
\item[A)] $3\sqrt2$
...
\item \textit{\small(after BMO1 2015 Q3)} Two tangents from $P$ make $60^\circ$ and $OP=10$, $r=OP\sin(\theta/2)=5$, tangent length $=OP\cos(\theta/2)$. What is the length?
\begin{itemize}
\item[A)] $5$
\item[B)] $5\sqrt3$
\item[C)] $10$
...
\end{tikzpicture} \textit{\small(adapted from MAT 2021 Q5)} The polar of $(9,12)$ w.r.t. $x^2+y^2=81$ is $3x+4y=27$. What is its distance from the origin, and is $P$ outside/inside/on?
\begin{itemize}
